...
- Install package without build isolation (fast rebuilds): `uv sync --inexact --no-dev --no-build-isolation-package mqt-syrec`
...
- NEVER edit `.pyi` files in `python/mqt/syrec/` manually; they are auto-generated by nanobind stubgen.
