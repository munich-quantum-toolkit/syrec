...
namespace syrec {
    ...
    protected:
        ...
        // TODO: Rework function signature to use parameter order lhs, rhs instead of the reverse to match the signature used for all other binary, unary and shift operations.
