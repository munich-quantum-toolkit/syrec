...
class SimulationRunWorkerRework(CancellableProducerConsumerWorker[SimulationRunModel, SimulationRunResult]):
    def __init__(
        self,
    ...
    def start_simulations(self) -> None:
        ...
        try:
            ...
            batch_start_timestamp = SimulationRunWorkerRework.get_timestamp()
            ...
            while self._should_continue_processing(found_outputs_mismatch, has_reached_end_sentinel):
                ...
                for _i in range(self.send_queue_batch_size):
                    if not self._should_continue_processing(found_outputs_mismatch, has_reached_end_sentinel):
                        break
                    ...
                    try:
                        ...
                        sim_run_execution_result: SimulationRunResult = (
                            SimulationRunWorkerRework._perform_single_sim_run_execution(
                ...
                n_remaining_batch_elems_to_generate = self.send_queue_batch_size
                batch_timestamps = SimulationRunWorkerRework.calc_batch_duration_and_return_end_timestamp_in_seconds(
    ...
    def _perform_single_sim_run_execution(
        ...
        sim_start_timestamp: Final[float] = SimulationRunWorkerRework.get_timestamp()
