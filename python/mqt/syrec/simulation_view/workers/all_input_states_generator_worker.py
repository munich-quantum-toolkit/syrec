...
class AllInputStatesGeneratorWorker(CancellableProducerWorker[SimulationRunModel]):
    ...
    def start_generation(self) -> None:
        ...
        try:
            ...
            n_data_qubits_per_generated_state: Final[int] = len(
                self._data_qubits_lookup.ascendingly_ordered_data_qubits_lookup
            )
            n_states_to_generate: Final[int] = 2**n_data_qubits_per_generated_state
                ...
                for integer_encoding_input_state in range(
                    ...
                    self.send_queue.put_nowait(
                        AllInputStatesGeneratorWorker._generate_sim_run_model_for_input_state(
                            self._num_qubits_per_generated_state,
                            n_data_qubits_per_generated_state,
                            integer_encoding_input_state,
    ...
    def _generate_sim_run_model_for_input_state(
        num_qubits_per_generated_state: int,
        n_data_qubits_per_generated_state: int,
        integer_defining_input_state: int,
        data_qubits_lookup: DataQubitsLookup,
    ) -> SimulationRunModel:
        ...
        return SimulationRunModel(
            ...
            n_data_qubits_in_state=n_data_qubits_per_generated_state,
